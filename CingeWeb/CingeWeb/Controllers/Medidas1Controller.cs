...
{
    public class Medidas1Controller : Controller
    {
        private readonly CingeWebContext _context;

        public Medidas1Controller(CingeWebContext context)
        {
            _context = context;
        }
